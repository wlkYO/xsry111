...
and yiji_kemu='$yiji_kemu' and erji_kemu='$erji_kemu' and yewu_type='$yewu_type'";
    ...
    public function createPingZheng($sdate,$edate){
        ...
        $arr_data = $c_data->searchProduct($sdate, $edate);
     ...
     * @param string $depts
     */
    public function searchProduct($sdate,$edate,$url='')
    {
        $url = empty($url)?"http://xsrb.wsy.me:801/saleStockSystem/index.php/qt/SPZDZD/search/type/1/token/30e051c3ab0f829bb52478ef2ad65d09/sdate/$sdate/edate/$edate":$url;
...
//        $result = $this->reCombineData($handleData,$type=1);
        return $handleData;
    }
    ...
    //处理商品类无效凭证
    public function createInvalidPz($sdate, $edate,$type)
    {
        $url = "http://xsrb.wsy.me:801/saleStockSystem/index.php/qt/SPZDZD/search/type/0/token/30e051c3ab0f829bb52478ef2ad65d09/sdate/$sdate/edate/$edate";
